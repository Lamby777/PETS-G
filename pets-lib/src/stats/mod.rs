...
/// Stats that are relatively static for a character or enemy type.
///
/// They don't change in battle or anything, but do when you level
/// up or use certain items and stuff.
#[derive(
    Clone,
    Debug,
    Eq,
...
impl std::ops::Add for LeveledStats {
    type Output = Self;
...
impl std::ops::Sub for LeveledStats {
    type Output = Self;
